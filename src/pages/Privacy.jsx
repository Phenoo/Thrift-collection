  ...
  return (
    <div className="policy">
      ...
      <h1 className="headline">
        ...
        <h6 className="grey">
        Updated at 2022-09-19
        </h6>
        <p>
          A SaaS Solution from Lampnet Technologies ("we," "our," or "us") is committed to protecting your privacy. This Privacy Policy explains how your personal information is collected, used, and disclosed by A SaaS Solution from Lampnet Technologies.
          This Privacy Policy applies to our website, nebo.com.ng , and its associated subdomains (collectively, our "Service") alongside our application, Nebo. By accessing or using our Service, you signify that you have read, understood, and agree to our collection, storage, use, and disclosure of your personal information as described in this Privacy Policy and our Terms of Service.
        </p>
        <div className="article">
          ...
          <ul>
            ...
            <li>
              ...
              <p>
                when this policy mentions “Company,” “we,” “us,” or “our,” it refers to Lampnet Technologies, 1B,Etim Iyang Cresent,Victoria Island that is responsible for your information under this Privacy Policy.
              </p>
            </li>
            <li>
              <h5>
              ...
              <p>
              where Nebo  or the owners/founders of Nebo app are based, in this case is Nigeria
              </p>
            </li>
            <li>
              <h5>
              ...
              <p>
                refers to the company, organization or person that signs up to use the Nebo  Service to manage the relationships with your consumers or service users.
              </p>
            </li>
            <li>
              <h5>
              ...
              <p>
              any internet connected device such as a phone, tablet, computer or any other device that can be used to visit Nebo App and use the services.
              </p>
            </li>
            <li>
              <h5>
            ...
            <li>
              ...
              <p>
              refers to those individuals who are employed by Nebo App or are under contract to perform a service on behalf of one of the parties.
              </p>
            </li>
            <li>
              <h5>personal data</h5>
            ...
            <li>
              ...
              <p>
              refers to the service provided by Nebo App as described in the relative terms (if available) and on this platform.
              </p>
            </li>
            <li>
            ...
            <li>
              ...
              <p>
                Nebo  website, which can be accessed via this URL: Nebo.com.ng.
            ...
            <li>
              ...
              <p>
                a person or entity that is registered with Nebo app to use the Services.
              </p>
            </li>
          </ul>
        </div>
        ...
        <div className="article">
          ...
          <p>
            ...
            discontinue our business or file a petition or have filed against us a petition in bankruptcy, reorganization or similar proceeding, provided that the third party agrees to adhere to the terms of this Privacy Policy.
          </p>
        </div>
        <div className="article">
          <h4 className="headline">
        ...
        <div className="article">
          ...
          <p>
            We are committed to helping our customers meet the data subject rights requirements of GDPR.Nebo processes or stores all personal data in fully vetted, DPA compliant vendors. We do store all conversation and personal data for up to 6 years unless your account is deleted. In which case, we dispose of all data in accordance with our Terms of Service and Privacy Policy, but we will not hold it longer than 60 days.
        ...
        <div>
          ...
          <p>
          Don't hesitate to contact us at support@lampnets.com if you have any questions.
          </p>
        </div>
